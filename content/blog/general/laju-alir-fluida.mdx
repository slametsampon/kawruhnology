...
A["Hitung L/D atau t/d"]

A --> B{"Rasio"}

B -->|" < 10 "| C["Orifice Equation"]

B -->|" ≥ 10 "| D["Pipe Equation"]

C --> E["Cd Based Flow"]

D --> F["Darcy atau Hagen"]
...
1. Crane Co. _Flow of Fluids Through Valves, Fittings, and Pipe_, Technical Paper No. 410.
2. I. E. Idelchik. _Handbook of Hydraulic Resistance_.
3. Perry, R. H. and Green, D. W. _Perry’s Chemical Engineers’ Handbook_.
4. Munson, B. R., Young, D. F., Okiishi, T. H., and Huebsch, W. W. _Fundamentals of Fluid Mechanics_.
5. ISO 5167. _Measurement of fluid flow by means of pressure differential devices inserted in circular cross-section conduits running full_.
