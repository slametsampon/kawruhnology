...
- [**_HortiLink Level 4A — Local HTTP Access_**](#hortilink-level-4a--local-http-access)
  ...
  - [4. Platform](#4-platform)
    - [4.1 Wiring Fisik dan Akses Lokal](#41-wiring-fisik-dan-akses-lokal)
  ...
  - [12. Sketch Level 4A](#12-sketch-level-4a)
    - [12.1 Diagram Layering dan Class Mapping](#121-diagram-layering-dan-class-mapping)
    - [12.2 Diagram Object Wiring / Composition Root](#122-diagram-object-wiring--composition-root)
    - [12.3 Diagram Struktur Domain di dalam `svc`](#123-diagram-struktur-domain-di-dalam-svc)
    - [12.4 Diagram Browser / Smartphone ↔ Node Interface](#124-diagram-browser--smartphone--node-interface)
...
### 4.1 Wiring Fisik dan Akses Lokal

Agar pembaca tidak hanya membaca platform sebagai daftar pin, hubungan antar pin, komponen fisik, dan akses smartphone pada Level 4A divisualisasikan sebagai berikut.
...
flowchart TB
    ...
    GPIO5["GPIO5"];
    SW_DRY["Dry Sensor Switch"];
    GND1["GND"];

    GPIO6["GPIO6"];
    SW_FAULT["Fault Switch"];
    GND2["GND"];
    ...
    GPIO7["GPIO7"];
    LED_ACT["Actuator LED"];
    GND3["GND"];

    NODE["ESP32-C3 Node<br/>SoftAP + HTTP Server"];
    PHONE["HP / Smartphone<br/>Browser"];
    WIFI["Wi-Fi AP Lokal<br/>SSID: HortiLink-Node"];
    ...
    NODE --> WIFI;
    PHONE -. "akses lokal via browser" .-> WIFI;

    classDef pin fill:#DBEAFE,stroke:#2563EB,color:#111,stroke-width:1.6px;
    classDef comp fill:#FEF3C7,stroke:#D97706,color:#111,stroke-width:1.6px;
    classDef gnd fill:#F1F5F9,stroke:#64748B,color:#111,stroke-width:1.4px;
    classDef node fill:#E8F5E9,stroke:#2E7D32,color:#111,stroke-width:1.8px;
    classDef net fill:#FCE4EC,stroke:#C2185B,color:#111,stroke-width:1.6px;

    class GPIO5,GPIO6,GPIO7,GPIO8 pin;
    class SW_DRY,SW_FAULT,LED_STATUS,LED_ACT comp;
    class GND1,GND2,GND3 gnd;
    class NODE node;
    class PHONE,WIFI net;
```
