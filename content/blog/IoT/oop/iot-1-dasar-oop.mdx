...
- [🏗️ **Konsep Inti yang Diperkenalkan: Fondasi yang Digunakan Berulang**](#️-konsep-inti-yang-diperkenalkan-fondasi-yang-digunakan-berulang)
  ...
  - [5. **Peran `firmware.ino` sebagai Orchestrator**](#5-peran-firmwareino-sebagai-orchestrator)
...
- [🛠️ **Desain Teknis \& Arsitektur: Bentuk Firmware yang Ditargetkan**](#️-desain-teknis--arsitektur-bentuk-firmware-yang-ditargetkan)
  ...
  - [2. **Tanggung Jawab `firmware.ino`**](#2-tanggung-jawab-firmwareino)
...
- [🧪 **Implementasi Bertahap: Dari Struktur ke Firmware Berjalan**](#-implementasi-bertahap-dari-struktur-ke-firmware-berjalan)
  ...
  - [4. **Integrasi Class ke `firmware.ino`**](#4-integrasi-class-ke-firmwareino)
...
- **Modul 4 – ComponentBase**
  Abstraksi lanjutan yang sepenuhnya bergantung pada pemahaman struktur class dan peran `firmware.ino`.
