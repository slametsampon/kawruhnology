...
<html>
  ...
  <body>
    ...
    <button class="control-btn" onclick="sendCommand('pump_on')">Turn Pump ON</button>
    <button class="control-btn" onclick="sendCommand('pump_off')">Turn Pump OFF</button>
    <br />
    <button class="control-btn" onclick="sendCommand('valve_open')">Open Valve</button>
    <button class="control-btn" onclick="sendCommand('valve_close')">Close Valve</button>
