...
![hortilink-tahap1](/kawruhnology/staticology/staticimages/IoT/hortilink-tahap1.webp)
...
![NodeMCU pinout](/kawruhnology/staticimages/IoT/nodemcu-v3-pinout-complete-final.png)

Sumber : https://cyberblogspot.com/nodemcu-v3-esp8266-pinout-and-configuration/

##### 4. **Wiring Diagram - Fritzing**

![hortiLink-tahap1_fritzing](/kawruhnology/staticimages/IoT/hortiLink-tahap1_fritzing.png)
...
![dashboard-tahap1](/kawruhnology/staticimages/IoT/HortiLink-tahap1.PNG)
...
1.  Dashboard - sebagai home base
    ![dashboard](/kawruhnology/staticimages/IoT/HortiLink-dashboard.PNG)

2.  Login/Logout - Authentication & Authorization user
    ![login](/kawruhnology/staticimages/IoT/HortiLink-login.PNG)

3.  Reporting
    ![reporting](/kawruhnology/staticimages/IoT/HortiLink-report.PNG)

4.  Configuration
    ![config](/kawruhnology/staticimages/IoT/HortiLink-config.PNG)

5.  About
    ![about](/kawruhnology/staticimages/IoT/HortiLink-about.PNG)
