...
![hortilink-tahap1](/kawruhnology/staticology/static/images/IoT/hortilink-tahap1.webp)
...
![NodeMCU pinout](/kawruhnology/static/images/IoT/nodemcu-v3-pinout-complete-final.png)

Sumber : https://cyberblogspot.com/nodemcu-v3-esp8266-pinout-and-configuration/

##### 4. **Wiring Diagram - Fritzing**

![hortiLink-tahap1_fritzing](/kawruhnology/static/images/IoT/hortiLink-tahap1_fritzing.png)
...
![dashboard-tahap1](/kawruhnology/static/images/IoT/HortiLink-tahap1.PNG)
...
1.  Dashboard - sebagai home base
    ![dashboard](/kawruhnology/static/images/IoT/HortiLink-dashboard.PNG)

2.  Login/Logout - Authentication & Authorization user
    ![login](/kawruhnology/static/images/IoT/HortiLink-login.PNG)

3.  Reporting
    ![reporting](/kawruhnology/static/images/IoT/HortiLink-report.PNG)

4.  Configuration
    ![config](/kawruhnology/static/images/IoT/HortiLink-config.PNG)

5.  About
    ![about](/kawruhnology/static/images/IoT/HortiLink-about.PNG)
