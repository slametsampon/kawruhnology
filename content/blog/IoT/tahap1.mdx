...
Selamat datang di **Proyek Serial [HortiLink](/blog/IoT/HortiLink): Tahap 1 – Pengembangan Sistem Monitoring dan Kontrol Individual (ESP-Node to Device)**!
...
![hortilink-tahap1](/staticology/static/images/IoT/hortilink-tahap1.webp)
...
[lebih detail pembuatan web server pada esp](/blog/IoT/web-server-esp)
...
[Lebih detail setup LittleFS](/blog/IoT/web-server-esp#4-struktur-folder-untuk-file-web)
