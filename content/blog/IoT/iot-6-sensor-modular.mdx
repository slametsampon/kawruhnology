...
- [🧪 **Implementasi Bertahap (High-Level)**](#-implementasi-bertahap-high-level)
  ...
  - [**7️⃣ Integrasi ke `main.ino`**](#7️⃣-integrasi-ke-mainino)
...
- dan dapat diintegrasikan tanpa menambah kompleksitas di `main.ino`.
...
- **Modul 4 – ComponentBase**
  ...
  - pemisahan lifecycle komponen dari `main.ino`
