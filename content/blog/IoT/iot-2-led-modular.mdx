...
- [🛠️ **Desain Teknis \& Arsitektur**](#️-desain-teknis--arsitektur)
  ...
  - [**Peran `main.ino` dalam Arsitektur**](#peran-mainino-dalam-arsitektur)
...
- [🧪 **Implementasi Bertahap (High-Level)**](#-implementasi-bertahap-high-level)
  ...
  - [**5. Mengintegrasikan Object LED ke `main.ino`**](#5-mengintegrasikan-object-led-ke-mainino)
    - [`main.ino`](#mainino)
...
- **Modul 1 – Dasar OOP & Struktur Proyek ESP**
  ...
  - Peran `main.ino` sebagai _entry point_ dan orkestrator, bukan tempat logika hardware
...
- **Memisahkan logika hardware dari `main.ino`**
  Seluruh detail terkait `pinMode`, `digitalWrite`, dan manajemen state ditempatkan di dalam class, menjadikan `main.ino` bersih dan berfungsi sebagai orkestrator.
...
- **Menggunakan kembali class LED tanpa mengubah kode utama**
  Class LED dirancang agar dapat di-_instantiate_ ulang untuk berbagai pin atau proyek lain tanpa modifikasi pada `main.ino`, mendukung prinsip _reusability_ dan _scalability_.
...
- **Menjadikan `main.ino` bebas dari detail hardware**
  `main.ino` hanya berfungsi sebagai pengatur alur aplikasi, tanpa pengetahuan langsung tentang cara LED dikendalikan secara teknis.
...
### **Peran `main.ino` dalam Arsitektur**

Dalam arsitektur ini, `main.ino` memiliki peran yang sangat terbatas dan terfokus, yaitu:
...
`main.ino` **tidak memiliki pengetahuan** tentang:
...
### **5. Mengintegrasikan Object LED ke `main.ino`**
...
`main.ino` hanya berperan sebagai **orkestrator**, tanpa pengetahuan detail tentang hardware LED.
...
- Tidak ada `digitalWrite()` di `main.ino`
...
- **`main.ino` tetap ringkas dan bersih**
...
- ⬅️ **Modul sebelumnya – Modul 1: Dasar OOP & Struktur Proyek ESP**
  Membahas fondasi konseptual OOP, struktur proyek firmware, serta peran `main.ino` sebagai pengatur alur aplikasi.
