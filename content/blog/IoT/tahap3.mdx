...
Selamat datang di **Proyek Serial [HortiLink](/blog/IoT/HortiLink): Tahap 3 – Integrasi ESP-Gateway dengan Server Kustom**
...
- **3. Implementasi MVC**
  ...
  [Lebih detail terkait data model dengan mongoDB-Mongose](/blog/IoT/dataModelHortiLink)
