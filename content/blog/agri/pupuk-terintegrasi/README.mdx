...
Berikut **README final versi master** untuk menjadi fondasi **re-writing menyeluruh** serial 5 artikel + 1 lampiran. Versi ini mempertahankan struktur asli manual, tetapi sudah menata ulang posisinya agar **mikroba masuk sebagai bagian sistem**, bukan tambahan belakangan. Arah ini tetap setia pada README awal yang menekankan manual praktis 5 bagian + lampiran, serta selaras dengan posisi JAKABA, MOL, POC, dan PGPM/PGPR sebagai input biologis pendukung, bukan pengganti pupuk utama.
...
- [README: Pupuk Tepat, Panen Untung: Model Low-Lab untuk Petani Makmur di Gambiran](#readme-pupuk-tepat-panen-untung-model-low-lab-untuk-petani-makmur-di-gambiran)
- [Sasaran Manual](#sasaran-manual)
- [Bentuk Tulisan yang Saya Sarankan](#bentuk-tulisan-yang-saya-sarankan)
...
- [Struktur Akhir yang Paling Tepat](#struktur-akhir-yang-paling-tepat)
  - [**5 Bagian Besar + 1 Lampiran**](#5-bagian-besar--1-lampiran)
