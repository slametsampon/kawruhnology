...
- [Bab 6. Studi Kasus Kolam `$1 \text{ m}^3$` untuk Nila `$200$` Ekor](#bab-6-studi-kasus-kolam-1-text-m3-untuk-nila-200-ekor)
  ...
  - [6.10. Koreksi Neraca Karbon dari Pakan](#610-koreksi-neraca-karbon-dari-pakan)
  - [6.11. Kebutuhan Karbon Tambahan Bila Dipakai sebagai Koreksi](#611-kebutuhan-karbon-tambahan-bila-dipakai-sebagai-koreksi)
  - [6.12. Kebutuhan Oksigen untuk Nitrifikasi](#612-kebutuhan-oksigen-untuk-nitrifikasi)
  - [6.13. Kebutuhan Oksigen untuk Ikan](#613-kebutuhan-oksigen-untuk-ikan)
  - [6.14. Kebutuhan Oksigen untuk Mikroba, Flok, dan Alga Malam](#614-kebutuhan-oksigen-untuk-mikroba-flok-dan-alga-malam)
  - [6.15. Total Kebutuhan Oksigen Puncak](#615-total-kebutuhan-oksigen-puncak)
  - [6.16. Estimasi Daya Aerator](#616-estimasi-daya-aerator)
  - [6.17. Diagram Neraca Oksigen Studi Kasus](#617-diagram-neraca-oksigen-studi-kasus)
  - [6.18. Jadwal Operasional dari Persiapan sampai Panen](#618-jadwal-operasional-dari-persiapan-sampai-panen)
  - [6.19. Protokol Monitoring](#619-protokol-monitoring)
  - [6.20. Protokol Koreksi Masalah](#620-protokol-koreksi-masalah)
  - [6.21. Diagram Keputusan Koreksi Lapangan](#621-diagram-keputusan-koreksi-lapangan)
  - [6.22. Evaluasi Panen](#622-evaluasi-panen)
  - [6.23. Ringkasan Angka Kunci Studi Kasus](#623-ringkasan-angka-kunci-studi-kasus)
...
- [Lampiran A. Model Matematik Kebutuhan Oksigen](#lampiran-a-model-matematik-kebutuhan-oksigen)
  ...
  - [LA.3. Karbon Pakan Efektif](#la3-karbon-pakan-efektif)
  - [LA.4. Fraksi Dominasi Heterotrof](#la4-fraksi-dominasi-heterotrof)
  - [LA.5. Oksigen untuk Proses Nitrogen](#la5-oksigen-untuk-proses-nitrogen)
  - [LA.6. Karbon Target, Karbon Efektif Total, dan Karbon Berlebih](#la6-karbon-target-karbon-efektif-total-dan-karbon-berlebih)
  - [LA.7. Produksi Flok atau `$VSS$`](#la7-produksi-flok-atau-vss)
  - [LA.8. Total Kebutuhan Oksigen Harian](#la8-total-kebutuhan-oksigen-harian)
  - [LA.9. Kebutuhan Aerasi](#la9-kebutuhan-aerasi)
  - [LA.10. Aplikasi pada Studi Kasus Kolam `$1 \text{ m}^3$`](#la10-aplikasi-pada-studi-kasus-kolam-1-text-m3)
    - [LA.10.1. Hitung Produksi `$TAN_{\text{N}}$`](#la101-hitung-produksi-tan_textn)
    - [LA.10.2. Hitung Karbon Pakan Efektif](#la102-hitung-karbon-pakan-efektif)
    - [LA.10.3. Hitung Karbon Target dan Defisit Karbon](#la103-hitung-karbon-target-dan-defisit-karbon)
    - [LA.10.4. Hitung Fraksi Heterotrof pada `$C/N = 10$`](#la104-hitung-fraksi-heterotrof-pada-cn--10)
    - [LA.10.5. Hitung `$O_2$` untuk Proses Nitrogen](#la105-hitung-o_2-untuk-proses-nitrogen)
    - [LA.10.6. Hitung `$O_2$` Ikan](#la106-hitung-o_2-ikan)
    - [LA.10.7. Komponen Mikroba Ringan dan Alga Malam](#la107-komponen-mikroba-ringan-dan-alga-malam)
    - [LA.10.8. Total Kebutuhan `$O_2$` Puncak Dasar](#la108-total-kebutuhan-o_2-puncak-dasar)
    - [LA.10.9. Estimasi Daya Aerator](#la109-estimasi-daya-aerator)
  - [LA.11. Ringkasan Output Studi Kasus](#la11-ringkasan-output-studi-kasus)
  - [LA.12. Cara Membaca Model](#la12-cara-membaca-model)
  - [LA.13. Batasan Model](#la13-batasan-model)
- [Lampiran B. Batas BFV Operasional agar Sedimentasi Tetap Mendukung Sistem BFT](#lampiran-b-batas-bfv-operasional-agar-sedimentasi-tetap-mendukung-sistem-bft)
  - [LB.1 Kenapa BFV Harus Dibatasi?](#a1-kenapa-bfv-harus-dibatasi)
  - [LB.2 Batasan BFV Valid Berdasarkan Komoditas dan Fase Budidaya](#a2-batasan-bfv-valid-berdasarkan-komoditas-dan-fase-budidaya)
    - [LB.2.1 Udang Vannamei / Shrimp BFT](#a21-udang-vannamei--shrimp-bft)
    - [LB.2.2 Nila / Tilapia BFT](#a22-nila--tilapia-bft)
    - [LB.2.3 Lele / African Catfish / Clarias BFT](#a23-lele--african-catfish--clarias-bft)
    - [LB.2.4 Ringkasan Batas BFV Praktis](#a24-ringkasan-batas-bfv-praktis)
  - [LB.3 BFV, Kualitas Air, dan Kesehatan Ikan/Udang](#a3-bfv-kualitas-air-dan-kesehatan-ikanudang)
  - [LB.4 Integrasi BFV dengan Sistem Pengendapan / Sedimentasi](#a4-integrasi-bfv-dengan-sistem-pengendapan--sedimentasi)
    - [LB.4.1 Rule Operasi Berdasarkan BFV Udang](#a41-rule-operasi-berdasarkan-bfv-udang)
    - [LB.4.2 Rule Operasi Berdasarkan BFV Nila](#a42-rule-operasi-berdasarkan-bfv-nila)
    - [LB.4.3 Rule Operasi Berdasarkan BFV Lele](#a43-rule-operasi-berdasarkan-bfv-lele)
    - [LB.4.4 Diagram Integrasi BFV dan Sedimentasi](#a44-diagram-integrasi-bfv-dan-sedimentasi)
  - [LB.5 Formula BFV Removal](#a5-formula-bfv-removal)
    - [LB.5.1 Selisih BFV](#a51-selisih-bfv)
    - [LB.5.2 Volume Settleable Solids Ekuivalen](#a52-volume-settleable-solids-ekuivalen)
    - [LB.5.3 Contoh Udang](#a53-contoh-udang)
    - [LB.5.4 Estimasi Waktu Operasi Sedimentasi](#a54-estimasi-waktu-operasi-sedimentasi)
    - [LB.5.5 Formula Penurunan BFV Aktual](#a55-formula-penurunan-bfv-aktual)
  - [LB.6 Integrasi BFV dengan FCR, SGR, dan Keputusan Bisnis](#a6-integrasi-bfv-dengan-fcr-sgr-dan-keputusan-bisnis)
    - [LB.6.1 Formula FCR](#a61-formula-fcr)
    - [LB.6.2 Formula SGR](#a62-formula-sgr)
    - [LB.6.3 Formula Survival Rate](#a63-formula-survival-rate)
    - [LB.6.4 Hubungan BFV dengan Indikator Bisnis](#a64-hubungan-bfv-dengan-indikator-bisnis)
  - [LB.7 SOP Monitoring BFV](#a7-sop-monitoring-bfv)
    - [LB.7.1 Frekuensi Pengukuran](#a71-frekuensi-pengukuran)
    - [LB.7.2 Cara Pengukuran](#a72-cara-pengukuran)
  - [LB.8 Rekomendasi Praktis untuk Artikel Utama](#a8-rekomendasi-praktis-untuk-artikel-utama)
  - [LB.9 Kesimpulan Lampiran A](#a9-kesimpulan-lampiran-a)
...
flowchart TD
    ...
    D --> I["Nitrifikasi lebih siap"]
    E --> J["Sludge keluar"]
    F --> K["Limbah pakan, TAN, dan karbon pakan"]
...
flowchart TD
    ...
    A --> E["Alga malam"]
    A --> X["Karbon korektif bila digunakan"]

    B --> F["7,2 g O2 per jam"]
    C --> G["2,2 g O2 per jam"]
    D --> H["3 g O2 per jam"]
    E --> I["1 g O2 per jam"]
    X --> Y["Tambahan O2 bila karbon diberikan"]

    F --> J["Total dasar 13,4 g O2 per jam"]
    G --> J
    H --> J
    I --> J

    J --> K["Faktor keamanan 2 kali"]
    K --> L["Desain dasar 26,8 g O2 per jam"]
    L --> M["Aerator 60 sampai 80 watt"]

    Y --> N["Validasi dengan DO subuh"]
    ...
    class A root;
    class B,C,D,E,X source;
    class F,G,H,I,Y number;
    class J,K,L design;
    class M result;
    class N warning;
```
...
flowchart TD
    ...
    F --> N["Hitung C pakan efektif sebelum karbon korektif"]
    N --> P["Karbon korektif hanya bila DO aman"]
...
flowchart TD
    ...
    A --> C["Hitung C pakan efektif"]

    B --> D["Tentukan C/N target"]
    D --> E["Hitung fraksi heterotrof"]

    C --> F["Hitung C efektif total"]
    G["C tambahan efektif"] --> F
    H["C organik lain efektif"] --> F

    D --> I["Hitung C target"]
    F --> J["Hitung C berlebih"]
    I --> J

    E --> K["Hitung O2 untuk nitrogen"]
    E --> L["Hitung produksi VSS"]
    J --> M["Hitung O2 karbon berlebih"]
    L --> N["Hitung O2 TSS"]

    K --> O["Total kebutuhan O2"]
    M --> O
    N --> O
    P["O2 ikan"] --> O
    Q["O2 alga malam"] --> O
    ...
    class A,D,G,H,P,Q,R input;
    class B,C,E,F,I,J,L process;
    class K,M,N,O oxygen;
    class S,T result;
```
