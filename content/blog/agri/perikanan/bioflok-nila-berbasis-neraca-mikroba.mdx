...
Bagian ini adalah inti bioflok. Praktisi tidak cukup hanya tahu bahwa “molase menurunkan amonia” atau “flok bisa dimakan ikan”. Yang harus dipahami adalah **mikroba mana yang bekerja, memakai energi dari mana, mengambil nitrogen dalam bentuk apa, menghasilkan apa, dan apa konsekuensi bisnisnya**.
...
Keempat jalur itu tidak selalu bekerja terpisah. Dalam satu kolam, heterotrof, nitrifier, alga, dan denitrifier bisa bekerja bersamaan. Tetapi dominansinya berubah tergantung **C/N ratio, cahaya, DO, pH, alkalinitas, TSS, sumber karbon, dan umur sistem**.
...
Nitrifier adalah kelompok bakteri chemoautotroph. Mereka berbeda dari heterotrof. Nitrifier tidak memakai molase sebagai sumber energi utama. Energinya berasal dari oksidasi nitrogen anorganik.
...
Nitrifier adalah pekerja lambat. Mereka tidak secepat heterotrof. Maka pada awal siklus bioflok, praktisi tidak boleh berharap nitrifikasi langsung stabil. Pada fase awal, heterotrof sering lebih dominan, terutama jika karbon organik ditambahkan.

---

## 3.3 Photoautotroph/Alga: Penyerap Nitrogen Berbasis Cahaya

Alga dan mikroalga memakai cahaya sebagai sumber energi. Mereka mengambil karbon dari $\mathrm{CO_2}$ atau $\mathrm{HCO_3^-}$, lalu mengambil nitrogen dari TAN, nitrit, atau nitrat untuk membentuk biomassa.
...
$$
\mathrm{DO}_{\text{subuh}}
<
\mathrm{DO}_{\text{siang}}
$$
...
Denitrifier adalah mikroba yang bekerja pada kondisi rendah oksigen atau anoksik. Mereka memakai nitrat atau nitrit sebagai akseptor elektron ketika oksigen bebas tidak cukup.
...
\text{cepat, tetapi menghasilkan padatan}
$$
...
\text{lambat, tetapi padatan rendah}
$$
...
\text{berguna siang hari, berisiko subuh}
$$
...
\text{berguna jika terkendali, berbahaya jika menjadi sludge anaerob}
$$
...
Praktisi tidak boleh mengambil keputusan hanya dari satu parameter.
