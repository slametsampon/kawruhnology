...
- [4. Stoikiometri Praktis: dari Pakan, TAN, Karbon, Oksigen, Alkalinitas, hingga TSS](#4-stoikiometri-praktis-dari-pakan-tan-karbon-oksigen-alkalinitas-hingga-tss)
  - [4.1 Mengapa Stoikiometri BFT Harus Dimulai dari Pakan, Bukan dari Molase](#41-mengapa-stoikiometri-bft-harus-dimulai-dari-pakan-bukan-dari-molase)
  - [4.2 Rumus Nitrogen Pakan](#42-rumus-nitrogen-pakan)
  - [4.3 Karbon Pakan Wajib Masuk dalam Neraca Input C/N](#43-karbon-pakan-wajib-masuk-dalam-neraca-input-cn)
  - [4.4 Dua Basis Perhitungan: Input C/N vs Koreksi TAN Aktual](#44-dua-basis-perhitungan-input-cn-vs-koreksi-tan-aktual)
    - [4.4.1 Basis A — Perencanaan Input C/N Harian](#441-basis-a--perencanaan-input-cn-harian)
  - [4.4.2 Basis B — Koreksi TAN Aktual](#442-basis-b--koreksi-tan-aktual)
  - [4.5 Microbial Efficiency: Rumus Koreksi TAN, Bukan Rumus Molase Harian](#45-microbial-efficiency-rumus-koreksi-tan-bukan-rumus-molase-harian)
  - [4.6 Disiplin Satuan: Karbon, Karbohidrat, dan Molase Tidak Boleh Dicampur](#46-disiplin-satuan-karbon-karbohidrat-dan-molase-tidak-boleh-dicampur)
  - [4.7 Konsekuensi Stoikiometri: Karbon Eksternal Bukan Input Gratis](#47-konsekuensi-stoikiometri-karbon-eksternal-bukan-input-gratis)
  - [4.8 Perbandingan Heterotrof dan Nitrifikasi dari Sudut Neraca](#48-perbandingan-heterotrof-dan-nitrifikasi-dari-sudut-neraca)
  - [4.9 Contoh Hitungan 1: Input C/N Harian dengan Menghitung Karbon Pakan](#49-contoh-hitungan-1-input-cn-harian-dengan-menghitung-karbon-pakan)
  - [4.10 Contoh Hitungan 2: Koreksi TAN Aktual](#410-contoh-hitungan-2-koreksi-tan-aktual)
  - [4.11 Hubungan Stoikiometri dengan TSS, BFV, dan Side-Stream Solids Removal](#411-hubungan-stoikiometri-dengan-tss-bfv-dan-side-stream-solids-removal)
  - [4.12 Koreksi Dosis Karbon Berdasarkan Kondisi Lapangan](#412-koreksi-dosis-karbon-berdasarkan-kondisi-lapangan)
  - [4.13 Pesan Bisnis dari Stoikiometri](#413-pesan-bisnis-dari-stoikiometri)
...
Avnimelech menempatkan manipulasi rasio karbon-nitrogen sebagai cara untuk mengendalikan nitrogen anorganik melalui penambahan sumber karbon dan sintesis protein mikroba oleh bakteri. Ebeling et al. kemudian membahas stoikiometri jalur photoautotroph, autotroph, dan heterotroph serta dampaknya terhadap kualitas air dan suspended solids. ([ScienceDirect][1])

```mermaid
flowchart TD
    A["Pakan harian"] --> B["Karbon pakan<br/>protein, lipid, karbohidrat"]
    A --> C["Nitrogen pakan<br/>protein × 0,16"]
    B --> D["Input C/N awal"]
    C --> D
    D --> E{"C/N sudah cukup?"}
    E --> F["Ya<br/>pantau TAN, TSS, DO"]
    E --> G["Tidak<br/>tambahkan karbon eksternal"]
    G --> H["Molase / gula / tapioka"]
    H --> I["Heterotrof tumbuh"]
    I --> J["TAN turun<br/>TSS dan O2 demand naik"]
...
$$
\left(C:N\right)_{\text{input}}
=

\frac{
C_{\text{feed}} + C_{\text{external}}
}{
N_{\text{feed}}
}
$$
...
\text{perkiraan nitrogen yang menjadi beban sistem}
$$
...
\text{nitrogen anorganik aktual yang sudah terukur di air}
$$
...
\text{karbon yang masuk dari pakan}
$$
...
$$
\left(C:N\right)_{\text{available}}
=

\frac{
C_{\text{available,feed}} + C_{\text{external}}
}{
N_{\text{excreted}}
}
$$
...
```mermaid
flowchart TD
    A["Keputusan karbon"] --> B["Basis A<br/>Input C/N harian"]
    A --> C["Basis B<br/>Koreksi TAN aktual"]

    B --> D["Hitung C_feed dan N_feed"]
    D --> E["Tambahkan karbon eksternal<br/>hanya jika C/N kurang"]

    C --> F["Ukur TAN aktual"]
    F --> G["Hitung ΔN_TAN"]
    G --> H["Tambahkan karbon cepat<br/>untuk koreksi TAN"]

    E --> I["Dosis awal"]
    H --> J["Dosis koreksi"]
    I --> K["Dosis final dikoreksi<br/>TSS, DO, BFV, pH"]
    J --> K

    classDef main fill:#E3F2FD,stroke:#1565C0,color:#0D47A1,stroke-width:1px;
    classDef route fill:#FFF3E0,stroke:#EF6C00,color:#E65100,stroke-width:1px;
    classDef process fill:#E8F5E9,stroke:#2E7D32,color:#1B5E20,stroke-width:1px;
    classDef final fill:#FFEBEE,stroke:#C62828,color:#B71C1C,stroke-width:1px;

    class A main;
    class B,C route;
    class D,E,F,G,H,I,J process;
    class K final;
```
...
\text{karbon eksternal yang perlu ditambahkan}
$$
...
\text{fraksi karbon dalam molase}
$$
...
\text{kenaikan TAN-N atau target penurunan TAN-N dalam } \mathrm{mg/L}
$$
...
\text{kebutuhan karbohidrat atau sumber karbon}
$$
...
\text{massa karbohidrat atau sumber karbon}
$$
...
\text{massa molase aktual yang ditimbang}
$$
...
Dari stoikiometri heterotrof Ebeling et al., setiap $1 \ \mathrm{g}$ TAN-N yang diproses melalui jalur heterotrof membutuhkan dan menghasilkan kira-kira: ([ScienceDirect][2])
...
```mermaid
flowchart TD
    A["Karbon eksternal<br/>molase/gula/tapioka"] --> B["Heterotrof aktif"]
    B --> C["TAN lebih cepat diikat"]
    B --> D["Kebutuhan O2 naik"]
    B --> E["Alkalinitas terpakai"]
    B --> F["VSS / TSS naik"]
    C --> G["Amonia lebih aman"]
    D --> H["Risiko DO subuh turun"]
    E --> I["Risiko pH turun"]
    F --> J["Risiko sludge & insang terganggu"]

    classDef input fill:#E3F2FD,stroke:#1565C0,color:#0D47A1,stroke-width:1px;
    classDef process fill:#E8F5E9,stroke:#2E7D32,color:#1B5E20,stroke-width:1px;
    classDef benefit fill:#FFF3E0,stroke:#EF6C00,color:#E65100,stroke-width:1px;
    classDef risk fill:#FFEBEE,stroke:#C62828,color:#B71C1C,stroke-width:1px;

    class A input;
    class B process;
    class C,G benefit;
    class D,E,F,H,I,J risk;
```
...
flowchart TD
    ...
    H --> I["Side-stream removal<br/>settling / clarifier"]
    I --> J["Sludge dibuang"]
    I --> K["Air kembali ke kolam"]
    ...
    classDef removal fill:#E0F2F1,stroke:#00695C,color:#004D40,stroke-width:1px;
...
$$
\text{VSS/TSS berlebih}
\rightarrow
\text{side-stream settling/clarifier}
\rightarrow
\text{sludge dibuang}
\rightarrow
\text{air kembali}
...
\text{hanya jika}
\quad
\text{TAN perlu dikendalikan dan sistem mampu menanggung } O_2 \text{ serta TSS}
$$
...
TSS \downarrow
+
DO_{\text{subuh}} \text{ aman}
\rightarrow
\text{karbon bisa ditambah bertahap}
$$
...
NO_2^- \uparrow
\rightarrow
\text{cek alkalinitas, DO, pH, dan maturasi nitrifier}
$$
...
$$
\text{kesalahan dosis karbon}
\rightarrow
\text{kesalahan biaya produksi}
\rightarrow
\text{kesalahan keputusan scale-up}
$$
...
2. Berapa karbon sudah masuk dari pakan?
3. Berapa TAN aktual di air?
4. Berapa DO dan alkalinitas tersedia?
5. Berapa TSS/BFV yang sudah terbentuk?
6. Apakah FCR dan respons makan membaik atau memburuk?
...
[1]: https://www.sciencedirect.com/science/article/pii/S004484869900085X?utm_source=chatgpt.com 'Carbon/nitrogen ratio as a control element in aquaculture ...'
[2]: https://www.sciencedirect.com/science/article/pii/S004484860600216X?utm_source=chatgpt.com 'Engineering analysis of the stoichiometry ...'
