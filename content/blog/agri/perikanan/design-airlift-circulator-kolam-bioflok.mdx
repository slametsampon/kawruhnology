...
- [Lampiran B – Data Eksperimen Airlift Wurts–Parker untuk Validasi Desain](#lampiran-b--data-eksperimen-airlift-wurtsparker-untuk-validasi-desain)
  - [B.1 Pendahuluan](#b1-pendahuluan)
- [B.2 Konfigurasi Eksperimen](#b2-konfigurasi-eksperimen)
  - [B.2.1 Geometri Airlift](#b21-geometri-airlift)
  - [B.2.2 Kondisi Operasi](#b22-kondisi-operasi)
  - [B.2.3 Posisi Outlet](#b23-posisi-outlet)
- [B.3 Data Hasil Uji Airlift Diameter 7,6 cm](#b3-data-hasil-uji-airlift-diameter-76-cm)
  - [B.3.1 Data Asli dalam L/min](#b31-data-asli-dalam-lmin)
- [B.4 Data yang Sama dalam m³/jam](#b4-data-yang-sama-dalam-mjam)
- [B.5 Analisis Pengaruh Kedalaman Injeksi](#b5-analisis-pengaruh-kedalaman-injeksi)
- [B.6 Data yang Digunakan pada Desain Gambiran](#b6-data-yang-digunakan-pada-desain-gambiran)
- [B.7 Data Optimum untuk Kedalaman Mendekati 80 cm](#b7-data-optimum-untuk-kedalaman-mendekati-80-cm)
- [B.8 Implikasi untuk Desain Airlift Praktis](#b8-implikasi-untuk-desain-airlift-praktis)
  - [Evaluasi Opsi Desain](#evaluasi-opsi-desain)
- [B.9 Kesimpulan Lampiran](#b9-kesimpulan-lampiran)
- [Lampiran C – Perhitungan Lengkap Transfer Oksigen (OTR, SOTR, SAE dan CO₂ Stripping)](#lampiran-c--perhitungan-lengkap-transfer-oksigen-otr-sotr-sae-dan-co-stripping)
  - [C.1 Pendahuluan](#c1-pendahuluan)
- [C.2 Definisi Parameter Transfer Massa](#c2-definisi-parameter-transfer-massa)
  - [C.2.1 Oxygen Transfer Rate (OTR)](#c21-oxygen-transfer-rate-otr)
    - [Definisi](#definisi)
    - [Persamaan](#persamaan)
    - [Satuan](#satuan)
    - [Makna Praktis](#makna-praktis)
  - [C.2.2 Standard Oxygen Transfer Rate (SOTR)](#c22-standard-oxygen-transfer-rate-sotr)
    - [Definisi](#definisi-1)
    - [Persamaan](#persamaan-1)
    - [Satuan](#satuan-1)
    - [Makna Praktis](#makna-praktis-1)
  - [C.2.3 Standard Aeration Efficiency (SAE)](#c23-standard-aeration-efficiency-sae)
    - [Definisi](#definisi-2)
    - [Persamaan](#persamaan-2)
    - [Satuan](#satuan-2)
    - [Makna Praktis](#makna-praktis-2)
    - [Interpretasi](#interpretasi)
  - [C.2.4 CO₂ Stripping](#c24-co-stripping)
    - [Definisi](#definisi-3)
    - [Mekanisme](#mekanisme)
    - [Faktor yang Mempengaruhi](#faktor-yang-mempengaruhi)
    - [Pentingnya pada Sistem Bioflok](#pentingnya-pada-sistem-bioflok)
- [C.3 Data Dasar Airlift Gambiran](#c3-data-dasar-airlift-gambiran)
  - [Data Operasi](#data-operasi)
- [C.4 Dasar Teori Transfer Oksigen](#c4-dasar-teori-transfer-oksigen)
  - [Persamaan OTR](#persamaan-otr)
  - [Persamaan SOTR](#persamaan-sotr)
  - [Hubungan OTR dan SOTR](#hubungan-otr-dan-sotr)
- [C.5 Estimasi Nilai KLa Airlift Gambiran](#c5-estimasi-nilai-kla-airlift-gambiran)
  - [Rentang Literatur](#rentang-literatur)
  - [Nilai Desain](#nilai-desain)
- [C.6 Perhitungan OTR Aktual](#c6-perhitungan-otr-aktual)
  - [Kondisi Kolam](#kondisi-kolam)
  - [OTR Minimum](#otr-minimum)
  - [OTR Maksimum](#otr-maksimum)
- [C.7 Perhitungan SOTR](#c7-perhitungan-sotr)
  - [SOTR Minimum](#sotr-minimum)
  - [SOTR Maksimum](#sotr-maksimum)
- [C.8 Standard Aeration Efficiency (SAE)](#c8-standard-aeration-efficiency-sae)
  - [Persamaan](#persamaan-3)
  - [SAE Minimum](#sae-minimum)
  - [SAE Maksimum](#sae-maksimum)
  - [Perbandingan SAE](#perbandingan-sae)
- [C.9 Oxygen Utilization Efficiency (OUE)](#c9-oxygen-utilization-efficiency-oue)
  - [Oksigen yang Masuk Melalui Udara](#oksigen-yang-masuk-melalui-udara)
  - [Massa Oksigen dalam Udara](#massa-oksigen-dalam-udara)
  - [Efisiensi Pemanfaatan Oksigen](#efisiensi-pemanfaatan-oksigen)
    - [Rentang OUE](#rentang-oue)
- [C.10 CO₂ Stripping](#c10-co-stripping)
  - [Dasar Teori](#dasar-teori)
  - [Mekanisme Utama](#mekanisme-utama)
  - [Estimasi Kapasitas CO₂ Stripping](#estimasi-kapasitas-co-stripping)
  - [Dampak terhadap Bioflok](#dampak-terhadap-bioflok)
- [C.11 Kapasitas Biomassa yang Dapat Didukung](#c11-kapasitas-biomassa-yang-dapat-didukung)
  - [Kebutuhan Oksigen Ikan](#kebutuhan-oksigen-ikan)
  - [Biomassa Minimum](#biomassa-minimum)
  - [Biomassa Maksimum](#biomassa-maksimum)
- [C.12 Diagram Neraca Oksigen dan CO₂](#c12-diagram-neraca-oksigen-dan-co)
- [C.13 Ringkasan Hasil](#c13-ringkasan-hasil)
- [C.14 Kesimpulan](#c14-kesimpulan)
...
A["50 cm<br/>65.5 L/min"]
--> B["65 cm<br/>73.9 L/min"]
--> C["80 cm<br/>111 L/min"]
...
1. Geometri paling dekat dengan konfigurasi aktual.
2. Data lengkap tersedia.
3. Masih berada dalam rentang operasi yang stabil.
4. Tidak memerlukan ekstrapolasi performa.
...
classDef blue fill:#1565C0,color:#fff
classDef green fill:#2E7D32,color:#fff
classDef orange fill:#EF6C00,color:#fff
