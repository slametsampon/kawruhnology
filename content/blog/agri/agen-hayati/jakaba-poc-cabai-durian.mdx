---
title: 'JAKABA, MOL, POC, dan PGPM: Formulasi, Fermentasi, Standar Mutu, serta Aplikasi pada Cabai dan Durian'
date: '2026-04-28'
tags:
  [
    'jakaba',
...
# **_JAKABA, MOL, POC, dan PGPM: Formulasi, Fermentasi, Standar Mutu, serta Aplikasi pada Cabai dan Durian_**

---

- [**_JAKABA, MOL, POC, dan PGPM: Formulasi, Fermentasi, Standar Mutu, serta Aplikasi pada Cabai dan Durian_**](#jakaba-mol-poc-dan-pgpm-formulasi-fermentasi-standar-mutu-serta-aplikasi-pada-cabai-dan-durian)
- [1. Konsep Dasar JAKABA, POC, MOL, dan PGPM](#1-konsep-dasar-jakaba-poc-mol-dan-pgpm)
  - [1.1 Latar Belakang](#11-latar-belakang)
    - [Ilustrasi 1. Posisi JAKABA, POC, MOL, dan PGPM dalam Sistem Budidaya](#ilustrasi-1-posisi-jakaba-poc-mol-dan-pgpm-dalam-sistem-budidaya)
  ...
  - [1.3 Pengertian POC](#13-pengertian-poc)
    ...
    - [Catatan Konseptual](#catatan-konseptual)
  - [1.4 Pengertian MOL](#14-pengertian-mol)
    - [Fungsi Utama MOL](#fungsi-utama-mol)
    - [Catatan Teknis](#catatan-teknis-1)
  - [1.5 Hubungan Konseptual MOL dan POC](#15-hubungan-konseptual-mol-dan-poc)
    - [MOL = Pembiakan Mikroba](#mol--pembiakan-mikroba)
    - [POC = Penguraian Bahan Organik oleh Mikroba](#poc--penguraian-bahan-organik-oleh-mikroba)
    - [Diagram 2. Hubungan MOL dan POC](#diagram-2-hubungan-mol-dan-poc)
    - [Diagram 3. Perbedaan Inti MOL dan POC](#diagram-3-perbedaan-inti-mol-dan-poc)
    - [Diagram 4. Urutan Kerja Praktis di Lapangan](#diagram-4-urutan-kerja-praktis-di-lapangan)
  - [1.6 Pengertian PGPM/PGPR](#16-pengertian-pgpmpgpr)
    - [Ilustrasi 5. Hubungan PGPM, PGPR, JAKABA, POC, dan MOL](#ilustrasi-5-hubungan-pgpm-pgpr-jakaba-poc-dan-mol)
  - [1.7 Perbedaan JAKABA, POC, MOL, dan PGPM](#17-perbedaan-jakaba-poc-mol-dan-pgpm)
    - [Ringkasan Praktis](#ringkasan-praktis)
  - [1.8 Mikroba yang Berpotensi Ada pada JAKABA dan MOL](#18-mikroba-yang-berpotensi-ada-pada-jakaba-dan-mol)
    ...
    - [Rujukan Lampiran Sumber Mikroba MOL](#rujukan-lampiran-sumber-mikroba-mol)
    - [Catatan Penting](#catatan-penting)
  - [1.9 Nutrisi dan Media Fermentasi yang Berpotensi Ada pada JAKABA, POC, dan MOL](#19-nutrisi-dan-media-fermentasi-yang-berpotensi-ada-pada-jakaba-poc-dan-mol)
    - [Ilustrasi 6. Alur Nutrisi, Mikroba, MOL, dan POC](#ilustrasi-6-alur-nutrisi-mikroba-mol-dan-poc)
  - [1.10 Posisi Agronomis JAKABA, POC, dan MOL](#110-posisi-agronomis-jakaba-poc-dan-mol)
  - [1.11 Batasan dan Risiko Salah Persepsi](#111-batasan-dan-risiko-salah-persepsi)
    ...
    - [3. MOL Bukan Pupuk Utama](#3-mol-bukan-pupuk-utama)
    - [4. Produk Fermentasi Buruk Dapat Bersifat Fitotoksik](#4-produk-fermentasi-buruk-dapat-bersifat-fitotoksik)
    - [5. Dosis Berlebihan Dapat Merusak Tanaman](#5-dosis-berlebihan-dapat-merusak-tanaman)
    - [6. Produk Berbau Busuk Tidak Layak Dipakai](#6-produk-berbau-busuk-tidak-layak-dipakai)
    - [7. Tetap Perlu Uji Kecil](#7-tetap-perlu-uji-kecil)
  - [1.12 Realitas Teknis: MOL, JAKABA, dan POC Tidak Terstandar](#112-realitas-teknis-mol-jakaba-dan-poc-tidak-terstandar)
    - [Masalah Uji Fitotoksik](#masalah-uji-fitotoksik)
    - [Posisi Agribisnis yang Disarankan](#posisi-agribisnis-yang-disarankan)
...
- [2. Formulasi, Fermentasi, dan Penyimpanan JAKABA 10 Liter](#2-formulasi-fermentasi-dan-penyimpanan-jakaba-10-liter)
  ...
  - [2.12 Tanda JAKABA Indikator awal fermentasi layak uji](#212-tanda-jakaba-indikator-awal-fermentasi-layak-uji)
...
- [3. Formulasi, Fermentasi, dan Penyimpanan POC 10 Liter](#3-formulasi-fermentasi-dan-penyimpanan-poc-10-liter)
  ...
  - [3.2 Hubungan Konseptual MOL dan POC](#32-hubungan-konseptual-mol-dan-poc)
    - [MOL = Pembiakan Mikroba](#mol--pembiakan-mikroba-1)
    - [POC = Penguraian Bahan Organik oleh Mikroba](#poc--penguraian-bahan-organik-oleh-mikroba-1)
    - [Hubungan MOL dan POC](#hubungan-mol-dan-poc)
    - [Perbedaan Fokus Proses MOL dan POC](#perbedaan-fokus-proses-mol-dan-poc)
    - [Penjelasan Singkat yang Sangat Praktis](#penjelasan-singkat-yang-sangat-praktis)
    - [Diagram 3.2. Alur Konseptual MOL dan POC](#diagram-32-alur-konseptual-mol-dan-poc)
    - [Diagram 3.3. Perbedaan Inti MOL dan POC](#diagram-33-perbedaan-inti-mol-dan-poc)
    - [Diagram 3.4. Urutan Kerja Praktis di Lapangan](#diagram-34-urutan-kerja-praktis-di-lapangan)
  - [3.3 Perbedaan POC Vegetatif dan POC Generatif](#33-perbedaan-poc-vegetatif-dan-poc-generatif)
    - [POC Vegetatif](#poc-vegetatif-1)
    - [POC Generatif](#poc-generatif-1)
    - [Catatan Teknis](#catatan-teknis-2)
  - [3.4 Sistem Fermentasi POC](#34-sistem-fermentasi-poc)
    - [Sistem Fermentasi yang Dapat Digunakan](#sistem-fermentasi-yang-dapat-digunakan)
    - [Ilustrasi 3.5. Sistem Fermentasi POC](#ilustrasi-35-sistem-fermentasi-poc)
    - [Rekomendasi Praktis](#rekomendasi-praktis)
  - [3.5 Formula POC Vegetatif 10 Liter](#35-formula-poc-vegetatif-10-liter)
    - [Perhitungan Formula POC Vegetatif](#perhitungan-formula-poc-vegetatif)
    - [Catatan Formula](#catatan-formula)
  - [3.6 Formula POC Generatif 10 Liter](#36-formula-poc-generatif-10-liter)
    - [Perhitungan Formula POC Generatif](#perhitungan-formula-poc-generatif)
    - [Catatan Formula](#catatan-formula-1)
  - [3.7 Fungsi Tiap Bahan dalam POC](#37-fungsi-tiap-bahan-dalam-poc)
    - [Penjelasan Fungsi Bahan](#penjelasan-fungsi-bahan)
  - [3.8 Formulasi dan Pembuatan MOL 10 Liter](#38-formulasi-dan-pembuatan-mol-10-liter)
    - [3.8.1 Pengertian MOL](#381-pengertian-mol)
    - [3.8.2 Perbedaan MOL, POC, dan JAKABA](#382-perbedaan-mol-poc-dan-jakaba)
    - [3.8.3 Formula MOL Serbaguna 10 Liter](#383-formula-mol-serbaguna-10-liter)
    - [Perhitungan Volume MOL](#perhitungan-volume-mol)
    - [Catatan Pemilihan Sumber Mikroba MOL](#catatan-pemilihan-sumber-mikroba-mol)
    - [3.8.4 Fungsi Tiap Bahan dalam MOL](#384-fungsi-tiap-bahan-dalam-mol)
    - [3.8.5 Cara Membuat Larutan Gula/Molase](#385-cara-membuat-larutan-gulamolase)
    - [Prosedur](#prosedur)
    - [3.8.6 Prosedur Pembuatan MOL 10 Liter](#386-prosedur-pembuatan-mol-10-liter)
    - [Peralatan](#peralatan)
    - [Langkah Pembuatan](#langkah-pembuatan)
    - [3.8.7 Sistem Fermentasi MOL](#387-sistem-fermentasi-mol)
    - [Ilustrasi 3.6. Fermentasi MOL](#ilustrasi-36-fermentasi-mol)
    - [3.8.8 Kondisi Fermentasi MOL](#388-kondisi-fermentasi-mol)
    - [3.8.9 Tanda MOL Indikator awal fermentasi layak uji](#389-tanda-mol-indikator-awal-fermentasi-layak-uji)
    - [3.8.10 Tanda MOL Gagal](#3810-tanda-mol-gagal)
    - [3.8.11 Penyaringan dan Penyimpanan MOL](#3811-penyaringan-dan-penyimpanan-mol)
    - [Prosedur Penyaringan](#prosedur-penyaringan)
    - [Contoh Label Batch MOL](#contoh-label-batch-mol)
    - [3.8.12 Masa Simpan MOL](#3812-masa-simpan-mol)
    - [3.8.13 Dosis Penggunaan MOL](#3813-dosis-penggunaan-mol)
    - [Rumus Penggunaan MOL](#rumus-penggunaan-mol)
    - [Contoh MOL sebagai Starter POC 10 Liter](#contoh-mol-sebagai-starter-poc-10-liter)
    - [3.8.14 Uji Aktivitas MOL Sebelum Digunakan](#3814-uji-aktivitas-mol-sebelum-digunakan)
    - [3.8.15 Catatan Keamanan Penggunaan MOL](#3815-catatan-keamanan-penggunaan-mol)
    - [Uji Fitotoksik MOL](#uji-fitotoksik-mol)
  - [3.9 Prosedur Fermentasi POC](#39-prosedur-fermentasi-poc)
    - [Peralatan](#peralatan-1)
    - [Prosedur Fermentasi](#prosedur-fermentasi)
    - [Ilustrasi 3.7. Alur Kerja Pembuatan POC 10 Liter](#ilustrasi-37-alur-kerja-pembuatan-poc-10-liter)
    - [Catatan Sanitasi](#catatan-sanitasi)
  - [3.10 Durasi Fermentasi POC](#310-durasi-fermentasi-poc)
    - [Tahapan Fermentasi](#tahapan-fermentasi)
    - [Catatan Khusus Bahan Ikan](#catatan-khusus-bahan-ikan)
  - [3.11 Tanda POC Indikator awal fermentasi layak uji](#311-tanda-poc-indikator-awal-fermentasi-layak-uji)
    - [Uji Kematangan Sederhana](#uji-kematangan-sederhana)
  - [3.12 Tanda POC Gagal](#312-tanda-poc-gagal)
    - [Penyebab Umum Kegagalan](#penyebab-umum-kegagalan)
  - [3.13 Standar Mutu dan Uji Kelayakan Sederhana POC](#313-standar-mutu-dan-uji-kelayakan-sederhana-poc)
  ...
  - [3.14 Penyaringan dan Penyimpanan POC](#314-penyaringan-dan-penyimpanan-poc)
    - [Prosedur Penyaringan](#prosedur-penyaringan-1)
    - [Label Batch Produksi](#label-batch-produksi)
    - [Penyimpanan](#penyimpanan)
    - [Ilustrasi 3.8. Alur Pasca-Fermentasi POC](#ilustrasi-38-alur-pasca-fermentasi-poc)
  - [3.15 Masa Simpan POC](#315-masa-simpan-poc)
  ...
  - [3.16 Risiko POC yang Perlu Dikendalikan](#316-risiko-poc-yang-perlu-dikendalikan)
    ...
    - [Ilustrasi 3.9. Titik Kendali Risiko POC](#ilustrasi-39-titik-kendali-risiko-poc)
...
- [4. Strategi Aplikasi pada Cabai Rawit, Cabai Besar, dan Durian](#4-strategi-aplikasi-pada-cabai-rawit-cabai-besar-dan-durian)
  ...
  - [4.9 Aplikasi pada Durian Belum Menghasilkan](#49-aplikasi-pada-durian-belum-menghasilkan)
    ...
    - [Catatan Teknis](#catatan-teknis-6)
...
- [Lampiran A: Sumber Mikroba Potensial untuk Pembuatan MOL](#lampiran-a-sumber-mikroba-potensial-untuk-pembuatan-mol)
...
- [Lampiran B: Metode Andal Pengujian MOL, JAKABA, dan POC](#lampiran-b-metode-andal-pengujian-mol-jakaba-dan-poc)
  - [1. Tentukan Dulu Klaim Produknya](#1-tentukan-dulu-klaim-produknya)
  - [2. Metode Uji Bertingkat](#2-metode-uji-bertingkat)
  - [Level 0 — Screening Awal di Lapangan](#level-0--screening-awal-di-lapangan)
  - [Level 1 — Uji Fisik-Kimia Murah](#level-1--uji-fisik-kimia-murah)
  - [Level 2 — Uji Fitotoksik Cepat](#level-2--uji-fitotoksik-cepat)
    - [Mengapa Uji Fitotoksik Penting?](#mengapa-uji-fitotoksik-penting)
    - [Benih yang Dapat Digunakan](#benih-yang-dapat-digunakan)
    - [Prosedur Sederhana GI](#prosedur-sederhana-gi)
    - [Penjelasan Pengenceran](#penjelasan-pengenceran)
    - [Alat dan Bahan](#alat-dan-bahan)
    - [Parameter yang Diamati](#parameter-yang-diamati-2)
    - [Rumus Germination Index](#rumus-germination-index)
    - [Contoh Perhitungan GI](#contoh-perhitungan-gi)
    - [Interpretasi Praktis](#interpretasi-praktis)
    - [Keputusan Setelah Uji GI](#keputusan-setelah-uji-gi)
    - [Uji Lanjutan pada Bibit Cabai](#uji-lanjutan-pada-bibit-cabai)
    - [Batasan Uji Fitotoksik](#batasan-uji-fitotoksik)
    - [Catatan Penting untuk MOL, JAKABA, dan POC](#catatan-penting-untuk-mol-jakaba-dan-poc)
    - [SOP Ringkas Uji Fitotoksik Cepat](#sop-ringkas-uji-fitotoksik-cepat)
    - [Diagram Uji Fitotoksik Cepat](#diagram-uji-fitotoksik-cepat)
    - [Kesimpulan Level 2](#kesimpulan-level-2)
  - [Level 3 — Uji Laboratorium Minimum](#level-3--uji-laboratorium-minimum)
  - [Level 4 — Uji Mikroba Fungsional](#level-4--uji-mikroba-fungsional)
  - [3. Metode Sampling yang Benar](#3-metode-sampling-yang-benar)
  - [4. Sistem Keputusan: Lolos, Terbatas, atau Tolak](#4-sistem-keputusan-lolos-terbatas-atau-tolak)
  - [5. Metode Paling Andal untuk Kondisi Petani](#5-metode-paling-andal-untuk-kondisi-petani)
  - [6. Penggunaan Berdasarkan Tingkat Data](#6-penggunaan-berdasarkan-tingkat-data)
  - [7. Diagram Metode Andal Pengujian](#7-diagram-metode-andal-pengujian)
  - [8. Kesimpulan Teknis](#8-kesimpulan-teknis)
...
```mermaid id="diagram-risiko-mol-poc-jakaba-tidak-standar"
flowchart TD
    A[MOL / JAKABA / POC Tidak Terstandar] --> B[Komposisi Mikroba Tidak Diketahui]
    A --> C[Populasi Mikroba Tidak Terukur]
    A --> D[pH dan EC Tidak Stabil]
    A --> E[Kandungan Hara Tidak Pasti]
    A --> F[Mutu Antarbatch Berbeda]

    B --> G[Risiko Mikroba Tidak Relevan atau Kontaminan]
    C --> H[Efektivitas Tidak Konsisten]
    D --> I[Risiko Akar Stres]
    E --> J[Tidak Bisa Menggantikan Pupuk Utama]
    F --> K[Setiap Batch Harus Diuji]

    G --> L[Tidak Layak Jadi Input Utama Komersial]
    H --> L
    I --> L
    J --> L
    K --> L

    L --> M[Hanya untuk Pendukung Terbatas]
    L --> N[Utamakan Produk Mikroba Teknis]

    classDef source fill:#fee2e2,stroke:#dc2626,color:#7f1d1d,stroke-width:3px;
    classDef risk fill:#fff7ed,stroke:#ea580c,color:#7c2d12,stroke-width:2px;
    classDef impact fill:#fef3c7,stroke:#d97706,color:#78350f,stroke-width:2px;
    classDef decision fill:#dcfce7,stroke:#16a34a,color:#14532d,stroke-width:3px;

    class A source;
    class B,C,D,E,F,G,H,I,J,K risk;
    class L impact;
    class M,N decision;
```
...
<ResourceBox
  ...
  items={[
    ...
    {
      name: 'Uji Fitotoksik Mikroba Sebelum Aplikasi MOL, POC, JAKABA, dan Produk Mikroba pada Tanaman',
      href: '/blog/agri/agen-hayati/uji-fitotosik-mikroba',
    },
    {
...
flowchart TD
    ...
    D3 --> H[Starter Mikroba dan Bioaktivator]
    D4 --> I[Efisiensi Hara dan Pertumbuhan Akar]
...
1. **MOL adalah proses pembiakan/perbanyakan mikroba.**
2. **POC adalah proses penguraian bahan organik oleh mikroba sehingga menghasilkan pupuk organik cair.**
...
```mermaid
flowchart TD
    A[Sumber mikroba lokal] --> A1[Rizosfer akar]
    A --> A2[Kompos matang]
    A --> A3[Kascing]
    A --> A4[Nasi basi putih]
    A --> A5[Tapai/fermentasi pangan]

    B[Media pembiakan mikroba] --> B1[Air cucian beras]
    B --> B2[Air kelapa]
    B --> B3[Molase/gula merah]
    B --> B4[Dedak/bekatul]
    B --> B5[Bonggol pisang]
    ...
    C --> D[Pembiakan/perbanyakan mikroba]
    D --> E[MOL aktif]
    E --> F[Starter fermentasi]

    F --> G[Proses POC]
    G --> G1[Bahan organik POC]
    G1 --> H[Daun hijau]
    G1 --> I[Buah/kulit buah]
    G1 --> J[Bonggol pisang]
    G1 --> K[Limbah ikan]
    G1 --> L[Urin ternak]

    F --> M[Mikroba mengurai bahan organik]
    H --> M
    I --> M
    J --> M
    K --> M
...
```mermaid
flowchart LR
    A[MOL] --> A1[Tujuan: membiakkan mikroba]
    A --> A2[Input: sumber mikroba + media]
    A --> A3[Output: starter mikroba aktif]

    B[POC] --> B1[Tujuan: menguraikan bahan organik]
    B --> B2[Input: bahan organik + starter mikroba]
    B --> B3[Output: pupuk organik cair]
...
```mermaid
flowchart TD
    A[Ambil sumber mikroba lokal] --> B[Buat MOL]
    B --> C[MOL aktif siap pakai]
    C --> D[Siapkan bahan organik untuk POC]
    D --> E[Tambahkan MOL sebagai starter]
    E --> F[Fermentasi dan penguraian bahan]
    F --> G[Saring]
    G --> H[POC matang]
    H --> I[Aplikasi ke tanaman setelah pengenceran]
```
...
Pada MOL, kelompok _Pseudomonas_, _Bacillus_, Actinomycetes, bakteri asam laktat, khamir, dan jamur saprofit juga berpotensi muncul tergantung sumber bahan. Namun, sama seperti JAKABA, keberadaannya tidak dapat dipastikan tanpa uji laboratorium.
...
flowchart TD
    ...
    H[Sumber Mikroba Lokal] --> I[Proses MOL]
    I --> J[MOL Aktif]
    J --> C

    D --> K[Rizosfer Lebih Aktif]
    E --> K
    F --> K
    G --> L[Tambahan Nutrisi Tanaman]
    K --> M[Serapan Hara Lebih Efisien]
    L --> M
    M --> N[Pertumbuhan Tanaman Lebih Baik]
```
...
flowchart LR
    ...
    F --> H[Starter POC dan Aktivator Kompos]
    H --> D
    H --> A

    E --> I[Tanah Lebih Aktif]
    E --> J[Akar Lebih Sehat]
    E --> K[Efisiensi Hara Lebih Baik]
    E --> L[Produksi Lebih Stabil]
```
...
| _Trichoderma_ teknis                | Layak untuk media, kompos, dan tanah        |
| _Bacillus/Pseudomonas_ teknis       | Layak untuk akar dan rizosfer               |
| _Beauveria_, _Metarhizium_, Bt, NPV | Layak untuk target hama tertentu            |
...
1. **Proses MOL = pembiakan atau perbanyakan mikroba**
2. **Proses POC = penguraian bahan organik oleh mikroba sehingga menghasilkan pupuk organik cair**
...
> Catatan:
> POC tidak terstandar tidak dapat menggantikan pupuk kimia utama karena kandungan hara, pH, EC, dan stabilitasnya tidak pasti. Sebelum digunakan, POC perlu diuji minimal melalui pH, EC, dan uji fitotoksik. Lihat Lampiran G.
...
```mdx id="rumus-gi-mol-poc-jakaba"
GI (%) =
...
```mdx id="uji-lanjutan-bibit-cabai"
...
```mdx id="kombinasi-uji-fitotoksik"
...
```mdx id="sop-ringkas-uji-fitotoksik-cepat"
...
```mermaid id="diagram-uji-fitotoksik-cepat"
flowchart TD
    A[MOL / JAKABA / POC Batch Baru] --> B[Screening Aroma dan Visual]
    B --> C{Bau Busuk / Belatung / Lendir Ekstrem?}

    C -->|Ya| D[Tolak Batch]
    C -->|Tidak| E[Siapkan Larutan Uji]

    E --> F[Kontrol Air Bersih]
    E --> G[Perlakuan 1:100]
    E --> H[Perlakuan 1:50]

    F --> I[Benih Cepat Tumbuh]
    G --> I
    H --> I

    I --> J[Inkubasi 48-72 Jam]
    J --> K[Hitung Kecambah]
    J --> L[Ukur Panjang Akar]
    K --> M[Hitung Germination Index]
    L --> M

    M --> N{GI > 80%?}
    N -->|Tidak| O{GI 60-80%?}
    O -->|Ya| P[Hanya Uji Terbatas]
    O -->|Tidak| D

    N -->|Ya| Q[Uji Kecil Bibit Cabai 3-5 Hari]
    Q --> R{Bibit Aman?}
    R -->|Tidak| D
    R -->|Ya| S[Layak Terbatas sebagai Pendukung]
    ...
    class A start;
    class B,E,F,G,H,I,J,K,L,M,Q test;
    class C,N,O,R decision;
    class D rejectcls;
    class P,S limited;
```
...
Untuk produk pupuk organik, pupuk hayati, dan pembenah tanah, Indonesia memiliki acuan persyaratan teknis minimal melalui Kepmentan No. 261/KPTS/SR.310/M/4/2019, sehingga pengujian tidak seharusnya hanya berdasarkan klaim visual atau testimoni. ([PSP Pertanian][2])
...
Untuk biofertilizer, quality control umumnya menekankan **jumlah mikroba hidup/viable count, viabilitas, dan kestabilan mikroba yang dijamin**. Panduan FNCA juga menggunakan metode hitung koloni dengan rentang 30–300 koloni pada plate sebagai dasar perhitungan populasi mikroba. ([FNCA][3])
...
```mdx id="sampling-mol-poc-jakaba"
Metode sampling:
...
```mermaid id="diagram-metode-andal-pengujian-mol-poc-jakaba"
flowchart TD
    A[MOL / JAKABA / POC Batch Baru] --> B[Screening Aroma dan Visual]
    B --> C{Ada Bau Busuk / Belatung / Lendir Hitam?}
    C -->|Ya| D[Tolak Batch]
    C -->|Tidak| E[Uji pH dan EC]

    E --> F{pH atau EC Berisiko?}
    F -->|Ya| G[Jangan ke Tanaman Utama]
    F -->|Tidak| H[Uji Fitotoksik GI 48-72 Jam]

    H --> I{GI > 80%?}
    I -->|Tidak| J[Tolak atau Uji Sangat Terbatas]
    I -->|Ya| K[Uji Kecil pada Tanaman Pinggir]

    K --> L{Tanaman Aman 3-5 Hari?}
    L -->|Tidak| D
    L -->|Ya| M[Uji Lab Berkala]

    M --> N{Lab Aman?}
    N -->|Tidak| G
    N -->|Ya| O[Layak Terbatas sebagai Pendukung]

    O --> P{Ingin Klaim PGPM / Agens Hayati?}
    P -->|Ya| Q[Uji Identitas Mikroba, CFU, dan Fungsi]
    P -->|Tidak| R[Gunakan sebagai Pendukung, Bukan Input Utama]

    classDef start fill:#dbeafe,stroke:#2563eb,color:#1e3a8a,stroke-width:3px;
    classDef test fill:#dcfce7,stroke:#16a34a,color:#14532d,stroke-width:2px;
    classDef decision fill:#fef3c7,stroke:#d97706,color:#78350f,stroke-width:2px;
    classDef reject fill:#fee2e2,stroke:#dc2626,color:#7f1d1d,stroke-width:3px;
    classDef limited fill:#f3e8ff,stroke:#7c3aed,color:#581c87,stroke-width:2px;

    class A start;
    class B,E,H,K,M,Q test;
    class C,F,I,L,N,P decision;
    class D,G,J reject;
    class O,R limited;
```
...
2. **pH dan EC**,
3. **uji fitotoksik/GI**,
4. **uji kimia laboratorium**,
5. **uji cemaran mikroba**,
6. **uji mikroba fungsional bila diklaim PGPM/agens hayati**,
7. **uji konsistensi antarbatch**.
...
[1]: https://www.sciencedirect.com/science/article/abs/pii/S0956053X21005262?utm_source=chatgpt.com 'Selection of sensitive seeds for evaluation of compost ...'
[2]: https://psp.pertanian.go.id/storage/494/Keputusan-Menteri-Pertanian-Nomor-261_KPTS_SR.310_M_4_2019-tentang-Persyaratan-Teknis-Minimal-Pupuk-Organik-Pupuk-Hayati-dan-Pembenah-Tanah.pdf?utm_source=chatgpt.com 'Keputusan-Menteri-Pertanian-Nomor-261_KPTS_SR ...'
[3]: https://www.fnca.mext.go.jp/english/bf/bfm/pdf/5_Quality_Control0403.pdf?utm_source=chatgpt.com '112 V. Quality Control of Biofertilizers 1. General Concept ...'
