...
flowchart TD
    ...
    classDef risk fill:#fecaca,stroke:#991b1b,color:#7f1d1d,stroke-width:3px;
    classDef result fill:#dbeafe,stroke:#2563eb,color:#1e3a8a,stroke-width:3px;

    class A,B,C,D input;
    class E decision;
    class F,H,I,J,O bad;
    class G,K,L,M,N good;
    class O risk;
    class P result;
```
