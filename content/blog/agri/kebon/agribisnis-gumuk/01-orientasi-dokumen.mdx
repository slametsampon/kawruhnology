...
Berikut **Bagian Awal — Response 2/2**, melanjutkan outline yang sudah dikunci untuk Bagian Awal.

## Response 2/2

### Summary (100 kata)

Response ini melengkapi Bagian Awal dengan elemen yang membuat dokumen benar-benar mudah dipakai oleh praktisi. Isinya mencakup cara menggunakan dokumen sesuai kebutuhan pembaca, ringkasan angka penting sebagai dashboard cepat, peta keputusan awal untuk memilih arah usaha, prinsip dasar yang harus dikunci sebelum masuk ke bab inti, definisi istilah kunci agar tidak terjadi salah tafsir, dan daftar isi sementara sebagai peta keseluruhan dokumen. Tujuan utamanya adalah memastikan pembaca tidak hanya memahami konteks lahan, tetapi juga tahu cara membaca manual ini, cara membuat keputusan awal, dan cara menempatkan setiap bagian dokumen dalam alur kerja usaha agribisnis.

### Tag

```text
['bagian-awal', 'cara-menggunakan-dokumen', 'ringkasan-angka-penting', 'peta-keputusan-cepat', 'prinsip-dasar', 'definisi-istilah-kunci', 'daftar-isi-sementara', 'manual-praktisi']
```
